...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-[67px] bg-[#232121] bg-opacity-50 navbar1 left-0 h-[300px] w-full z-10 text-white flex flex-col items-center justify-center gap-4 px-3 transform ${
