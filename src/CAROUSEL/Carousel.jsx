...
const Carousel = () => {
  ...
  return (
    ...
    <div class="mt-8 flex items-center justify-center">
        ...
        <a href="mailto:shahed32156@gmail.com" target="_blank"><button class="text-white font-semibold text-center hover:bg-[#bc2bcc] hover:transition hover:duration-500 border-[1px] border-[#bc2bcc] p-2 rounded-md">Hire me</button></a>
